...
function ContactSection() {
  return (
    <div id="contact" className="my-8 lg:my-12 relative mt-12 text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
        ...
        <Reveal direction="right" delay={0.15} className="lg:w-3/4 ">
          <div className="flex flex-col gap-5 lg:gap-9">
            <p className="text-sm md:text-xl flex items-center gap-3">
              <MdAlternateEmail
                className="bg-[#8b98a5] p-2 rounded-full hover:bg-lime-400 hover:scale-110 transition-all duration-300 text-gray-800 cursor-pointer"
                size={36}
              />
              <span>{personalData.email}</span>
            </p>
            {personalData.phone && !personalData.phone.includes('XXXXX') && (
              <p className="text-sm md:text-xl flex items-center gap-3">
                <IoMdCall
                  className="bg-[#8b98a5] p-2 rounded-full hover:bg-lime-400 hover:scale-110 transition-all duration-300 text-gray-800 cursor-pointer"
                  size={36}
